      ...
      <aside className="w-full md:w-64 bg-cardBg border-r border-cardBg/50 flex flex-col justify-between p-6">
        <div>
          <div className="mb-10 text-center md:text-left">
            ...
            <div className="mt-2 text-xs text-textGray font-semibold bg-primary/10 border border-primary/25 rounded-full px-3 py-1 max-w-max mx-auto md:mx-0">
              🟢 Active Profile
            </div>
          </div>
      ...
      <main className="flex-1 p-6 md:p-10 max-w-7xl mx-auto w-full">
        ...
        {activeTab === 'overview' && (
          <div className="space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h1 className="text-3xl font-black">Welcome Back, {profile.username}!</h1>
                <p className="text-textGray text-sm">Monitor your earnings and complete tasks to cash out.</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="bg-cardBg border border-cardBg p-6 rounded-2xl relative overflow-hidden">
                ...
                <p className="text-3xl font-black text-primary">৳ {profile.balance.toFixed(2)}</p>
              ...
              <div className="bg-cardBg border border-cardBg p-6 rounded-2xl relative overflow-hidden">
                ...
                <p className="text-3xl font-black text-accent">{profile.referral_count} Users</p>
              ...
              <div className="bg-cardBg border border-cardBg p-6 rounded-2xl relative overflow-hidden">
                ...
                <p className="text-3xl font-black text-textLight">{profile.ads_watched_today} / 15</p>
            ...
            <div className="bg-cardBg/50 border border-cardBg rounded-2xl p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-textLight mb-1">Withdrawal Requirements Check:</h4>
              ...
              <div className="flex items-center gap-2 bg-background border border-cardBg rounded-xl px-4 py-2 text-xs font-semibold">
        ...
        {activeTab === 'watch-ads' && (
          <div className="space-y-8 max-w-2xl">
            <div>
              <h1 className="text-3xl font-black">Ad Reward System</h1>
            ...
            <div className="bg-cardBg border border-cardBg rounded-2xl p-6">
              ...
              {isWatching ? (
                <div className="bg-background rounded-2xl p-10 border border-primary/20 text-center space-y-4">
                  ...
                  <h3 className="text-xl font-bold">Watching Advertisement...</h3>
                ...
                <div className="bg-background rounded-2xl p-10 border border-cardBg text-center space-y-4">
                  ...
                  <h3 className="text-xl font-bold">Cooldown Active</h3>
                  <p className="text-textGray text-xs max-w-sm mx-auto">
                ...
                <button
                  ...
                  className="w-full py-6 bg-primary text-background text-lg font-black rounded-2xl hover:bg-opacity-90 shadow-lg shadow-primary/25 transition-all flex items-center justify-center gap-3"
                >
                  <Play className="w-6 h-6 fill-background" /> Click to Watch Ad & Earn 5 ৳
                </button>
              )}
            </div>
          </div>
        ...
        {activeTab === 'withdraw' && (
          <div className="space-y-8">
            <div>
              <h1 className="text-3xl font-black">Withdraw Earnings</h1>
              <p className="text-textGray text-sm">Send your withdrawal request directly to bKash, Nagad, or Rocket.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <form onSubmit={handleWithdraw} className="space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      {['bkash', 'nagad', 'rocket'].map((method) => (
                        <button
                          ...
                          className={`py-3 px-4 rounded-xl border font-bold capitalize transition-all ${wdMethod === method ? 'bg-primary border-primary text-background shadow-lg shadow-primary/10' : 'bg-background border-cardBg text-textGray hover:text-textLight'}`}
                        >
                          {method}
                        </button>
                      ))}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-background border border-cardBg rounded-xl text-textLight focus:border-primary focus:outline-none transition-colors"
                    />
                    <div className="mt-2 text-xs text-textGray flex justify-between">
              ...
              <div className="bg-cardBg border border-cardBg rounded-2xl p-6 space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between text-sm border-b border-background pb-3">
                ...
                <div className="p-4 bg-background border border-cardBg rounded-xl text-xs text-textGray leading-relaxed">
            ...
            <div className="bg-cardBg border border-cardBg rounded-2xl p-6">
              ...
              {wdHistory.length === 0 ? (
                <p className="text-textGray text-sm text-center py-6">No withdrawal history found.</p>
              ) : (
                    ...
                    <tbody className="text-sm">
                      {wdHistory.map((row) => (
                        <tr key={row.id} className="border-b border-cardBg/30">
                          <td className="py-3 text-xs text-textGray">
                          ...
                          <td className="py-3">
                            <span className={`px-2.5 py-1 rounded-full text-xs font-bold ${row.status === 'approved' ? 'bg-primary/10 text-primary border border-primary/20' : row.status === 'rejected' ? 'bg-red-500/10 text-red-500 border border-red-500/20' : 'bg-accent/10 text-accent border border-accent/20'}`}>
                              {row.status}
                            </span>
                          </td>
                        </tr>
        ...
        {activeTab === 'referrals' && (
          <div className="space-y-8 max-w-2xl">
            <div>
              <h1 className="text-3xl font-black">Referral System</h1>
            ...
            <div className="bg-cardBg border border-cardBg rounded-2xl p-6 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-background border border-cardBg rounded-xl text-xs text-primary font-medium focus:outline-none"
                />
                <button
                  onClick={copyReferralLink}
                  className="px-6 py-3 bg-primary text-background font-black rounded-xl hover:bg-opacity-90 shadow-lg shadow-primary/25 transition-all flex items-center justify-center gap-2"
                >
            ...
            <div className="bg-cardBg border border-cardBg rounded-2xl p-6 flex items-center justify-between">
              <div>
                ...
                <p className="text-textGray text-xs mt-1">Only active activated referrals are counted.</p>
              </div>
              <div className="text-4xl font-black text-accent">{profile.referral_count} Users</div>
            </div>
          </div>
        )}
      </main>
